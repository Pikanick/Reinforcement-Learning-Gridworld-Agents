...
class PassAllTestsQuestion(Question):
    ...
    def execute(self, grades):
        # TO DO: is this the right way to use grades?  The autograder doesn't seem to use it.
        testsFailed = False
...
class HackedPartialCreditQuestion(Question):
    ...
    def execute(self, grades):
        ...
        # FIX ME: Below terrible hack to match q3's logic
...
class TestCase(object):
    ...
    #
    # TO DO: this is hairy, but we need to fix grading.py's interface
